...
public class login_error extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet login_error</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            while(items.hasNext())
        {
         ...
         out.println("</ul>");
        out.println("</font>");
        out.println("<a href='login_page.jsp'>Go to Login page </a>");
            
            
            out.println("<h1>Servlet login_error at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
